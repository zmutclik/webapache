...
RUN apt -y install iproute2 nano iputils-ping lsb-release gnupg2 ca-certificates apt-transport-https software-properties-common gcc make autoconf libc-dev pkg-config logrotate cron iputils-ping traceroute gh
...
RUN apt -y install php$PHPVERSION-intl php$PHPVERSION-curl php$PHPVERSION-zip
